...
import { tescoSitemapRouter } from './routes/tescoSitemap.js';
import { tescoWorkerRouter } from './routes/tescoWorker.js';
import { supermarketAutomationRouter } from './routes/supermarketAutomation.js';
...
app.use(tescoSitemapRouter);
app.use(tescoWorkerRouter);
app.use(supermarketAutomationRouter);
